  ...
  function (t, i, e) {
    ...
    (r.prototype.getModelMatrix = function () {
      ...
      (r.prototype.loadExpression = function (t, i, e) {
        ...
        var n = this;
        r.loadBytes(i, function (i) {
          t != null && (n.expressions[t] = o.loadJson(i)),
            typeof e === "function" && e();
        });
      }),
      ...
      !(function () {
        ...
        (i._$0s = 1),
          ...
          (i.prototype.getModelImpl = function () {
            return (
              this._$MT == null && ((this._$MT = new p()), this._$MT._$zP()),
              this._$MT
            );
          }),
          ...
          (i.prototype.setParamFloat = function (t, i, e) {
            typeof t !== "number" && (t = this._$5S.getParamIndex(u.getID(t))),
          ...
          (i.prototype.getIndexArray = function (t) {
            ...
            return i != null && i.getType() == W._$wb && i instanceof $t
              ? i.getIndexArray()
              : null;
          }),
          (e.CHANNEL_COUNT = 4),
          ...
          (s.prototype.updateParam = function (t, i) {
            if (i._$AT && !i._$9L) {
              ...
              (o =
                o *
                (this._$dP == 0 ? 1 : ht._$r2((e - i._$bs) / this._$dP)) *
                (this._$eo == 0 || i._$Do < 0
                  ? 1
                  : ht._$r2((i._$Do - e) / this._$eo))),
                (o >= 0 && o <= 1) || console.log("### assert!! ### "),
          ...
          (_.start = function (t) {
            var i = _._$fT[t];
            i == null && ((i = new a()), (i._$r = t), (_._$fT[t] = i)),
          ...
          (p.prototype._$zP = function () {
            this._$vo == null && (this._$vo = new ot()),
        ...
        (It._$ni = function (t, i, e, r, o, n, s, _, a) {
          ...
          return (
            ...
            a == null ? new Array(l, $) : ((a[0] = l), (a[1] = $), a)
          );
        }),
        ...
        (Y._$V2 = -1),
          ...
          (Y.prototype.getDrawDataIndex = function (t) {
            for (var i = this._$aS.length - 1; i >= 0; --i)
              if (this._$aS[i] != null && this._$aS[i].getDrawDataID() == t)
                return i;
            return -1;
          }),
            ...
            for (var d = o.length, g = yt._$2o(); ;) {
              for (var y = !1, s = 0; s < d; ++s) {
                ...
                if (m != null) {
                  ...
                  (T == null || T == g || this.getBaseDataIndex(T) >= 0) &&
                    (this._$3S.push(m),
                      this._$db.push(n[s]),
                      (o[s] = null),
                      (y = !0));
          ...
          (Y.prototype.getBaseDataIndex = function (t) {
            for (var i = this._$3S.length - 1; i >= 0; --i)
              if (this._$3S[i] != null && this._$3S[i].getBaseDataID() == t)
                return i;
            return -1;
          }),
        ...
        (at._$yr = !1),
          ...
          ($t.prototype._$F0 = function (t) {
            ...
            if (
              ...
              if (((this._$JP = t._$6L()), this._$JP != 0)) {
                if ((1 & this._$JP) != 0) {
                  var r = t._$6L();
                  this._$5P == null && (this._$5P = new Object()),
          ...
          (St.prototype._$fP = function () {
            ...
            if ((128 & (t = this._$ST())) == 0)
              return ((127 & r) << 7) | (127 & t);
            if ((128 & (i = this._$ST())) == 0)
  ...
  function (t, i, e) {
    ...
    (o.prototype = new n.L2DBaseModel()),
      ...
      this.modelSetting.loadModelSetting(i, function () {
          r.baseUrl = r.modelSetting.getBaseUrl();
          if (/^https?:\/\/|^\/\//i.test(r.modelSetting.getModelFile()))
            var t = r.modelSetting.getModelFile();
          else var t = r.baseUrl ? r.baseUrl + r.modelSetting.getModelFile() : r.modelHomeDir + r.modelSetting.getModelFile();
          r.loadModelData(t, function (t) {
            for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
              ...
              else var o = r.baseUrl ? r.baseUrl + r.modelSetting.getTextureFile(i) : r.modelHomeDir + r.modelSetting.getTextureFile(i);
                ...
                if (r.isTexLoaded) {
                  if (r.modelSetting.getExpressionNum() > 0) {
                    ...
                    for (
                      ...
                      if (
                        /^https?:\/\/|^\/\//i.test(
                          r.modelSetting.getExpressionName(t)
                        )
                      )
                        var o = r.modelSetting.getExpressionFile(t);
                      else
                        var o = r.baseUrl ? r.baseUrl + r.modelSetting.getExpressionFile(t) : r.modelHomeDir + r.modelSetting.getExpressionFile(t);
                      r.loadExpression(o, o);
                    }
                  } else (r.expressionManager = null), (r.expressions = {});
                  if (
                    (r.eyeBlink,
                      r.modelSetting.getPhysicsFile() != null
                        ? r.loadPhysics(r.baseUrl ? r.baseUrl + r.modelSetting.getPhysicsFile() : r.modelHomeDir + r.modelSetting.getPhysicsFile())
                        : (r.physics = null),
                      r.modelSetting.getPoseFile() != null
                        ? r.loadPose(r.baseUrl ? r.baseUrl + r.modelSetting.getPoseFile() : r.modelHomeDir + r.modelSetting.getPoseFile(), function () {
                          r.pose.updateParam(r.live2DModel);
                        })
                        : (r.pose = null),
                      r.modelSetting.getLayout() != null)
                  ) {
                    var n = r.modelSetting.getLayout();
                    n.width != null && r.modelMatrix.setWidth(n.width),
                      n.height != null && r.modelMatrix.setHeight(n.height),
                      n.x != null && r.modelMatrix.setX(n.x),
                      n.y != null && r.modelMatrix.setY(n.y),
                      n.center_x != null && r.modelMatrix.centerX(n.center_x),
                      n.center_y != null && r.modelMatrix.centerY(n.center_y),
                      n.top != null && r.modelMatrix.top(n.top),
                      n.bottom != null && r.modelMatrix.bottom(n.bottom),
                      n.left != null && r.modelMatrix.left(n.left),
                      n.right != null && r.modelMatrix.right(n.right);
                  }
      ...
      this.baseUrl = this.modelSetting.getBaseUrl();
        for (var i = this, e = 0; e < this.modelSetting.getMotionNum(t); e++) {
          if (/^https?:\/\/|^\/\//i.test(this.modelSetting.getMotionFile(t, e)))
            var r = this.modelSetting.getMotionFile(t, e);
          else
            var r = this.baseUrl ? this.baseUrl + this.modelSetting.getMotionFile(t, e) : this.modelHomeDir + this.modelSetting.getMotionFile(t, e);
      ...
      (o.prototype.update = function () {
        ...
        if (this.mainMotionManager.isFinished()) {
          sessionStorage.getItem("Sleepy") === "1"
      ...
      (o.prototype.startMotion = function (t, i, e) {
        ...
        var n = this;
        this.motions[t] == null
          ? this.loadMotion(null, this.baseUrl ? this.baseUrl + r : this.modelHomeDir + r, function (r) {
      ...
      (o.prototype.setFadeInFadeOut = function (t, i, e, r) {
        ...
        if (
          ...
          (s.src = this.baseUrl ? this.baseUrl + n : this.modelHomeDir + n),
  ...
  function (t, i, e) {
    ...
    (r.prototype.loadModelSetting = function (t, i) {
      ...
      (r.prototype.getTextureFile = function (t) {
        return this.json[this.TEXTURES] == null ||
          this.json[this.TEXTURES][t] == null
          ? null
      ...
      (r.prototype.getBaseUrl = function () {
        return this.json[this.BASE_URL] || null;
      }),
      ...
      (r.prototype.getHitAreaNum = function () {
        return this.json[this.HIT_AREAS] == null
          ? 0
          : this.json[this.HIT_AREAS].length;
      }),
      (r.prototype.getHitAreaID = function (t) {
        return this.json[this.HIT_AREAS] == null ||
          this.json[this.HIT_AREAS][t] == null
          ? null
      ...
      (r.prototype.getInitParamID = function (t) {
        return this.json[this.INIT_PARAM] == null ||
          this.json[this.INIT_PARAM][t] == null
          ? null
